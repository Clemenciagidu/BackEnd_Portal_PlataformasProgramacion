    ...
    <div class="container py-md-5">
            ...
            <ul class="list-unstyled row text-center mt-lg-5 mt-4 px-lg-5">
                ...
                <li class="col-md-4 col-sm-6 adress-w3pvt-info mb-4">
                    ...
                    <h6>Teléfono & Email</h6>
                    <p>+(57) 301 361 2345</p>
                    <a href="mailto:info@example.com" class="mail">clemencia.giraldo@upb.edu.co</a>
                </li>
                 <li class="col-md-4 col-sm-6 adress-w3pvt-info mb-4">
                    <div class="adress-icon">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 contact-left-form">
                        <form action="#" method="post">
                            ...
                            <div class="form-group contact-forms">
                              <textarea class="form-control" placeholder="Cuéntanos tus inquietudes" rows="3" required=""></textarea>
                            </div>
