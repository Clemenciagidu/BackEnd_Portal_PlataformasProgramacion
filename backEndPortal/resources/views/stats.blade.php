        ...
        <div class="container py-lg-5 py-md-3">
            <div class="row stat-grids">
                <div class="col-lg-6 stats-left">
                    <h3 class="heading mb-4 text-li"><br><br>El turismo en cifras</h3>
                    <p class="mb-3">Hoy los viajes se han vuelto la norma y no una excepción. Todos aspiramos a viajar y los vemos como algo normal en nuestras vidas. Cuando hace solo unas décadas, los viajes internacionales estaban reservados a una pequeña élite.</p>
                    <h4><span>1.500 Millones</span> Turistas en el Mundo</h4>
                </div>
                <div class="col-lg-6 grid1 stats-right mt-lg-0 mt-4 pl-5">
                    <div class="row">
                        <div class="col-sm-4 col-6 mb-4">
                            <p class="text-li"><br>Crecimiento del turismo en 10 años</p>
                            <h4 class="text-wh">70%</h4>
                            <span class="fa fa-users mr-2"></span>
                        </div>
                        <div class="col-sm-4 col-6 mb-4">
                            <p><br>Del turismo mundial, europa recibe</p>
                            <h4>51%</h4>
                            <span class="fa fa-tasks mr-2"></span>
                        </div>
                        <div class="col-sm-4 col-6 mb-4">
                            <p><br>Crecimiento turístico en Colombia</p>
                            <h4>3,7%</h4>
